...
@Composable
fun LocalAdminFranjasTab(viewModel: LocalAdminViewModel) {
    ...
    AdminTabScaffold(
        items = franjas,
        loading = isLoading,
        textoVacio = "No hay franjas en tus locales",
        ...
        AdminCard {
            Row(verticalAlignment = Alignment.CenterVertically) {
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        text = "${franja.localComida ?: "—"} · ${franja.pedidosActuales}/${franja.capacidadMaxima}",
