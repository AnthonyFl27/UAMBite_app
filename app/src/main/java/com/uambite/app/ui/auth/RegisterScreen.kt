...
fun RegisterScreen(
    ...
    LaunchedEffect(state) {
        if (state is AuthViewModel.RegisterUiState.Success) {
            onRegisterSuccess()
    ...
    Scaffold(
        ...
        Column(
            ...
            val errorState = state as? AuthViewModel.RegisterUiState.Error
            if (errorState != null) {
                Text(
            ...
            Button(
                onClick = {
                    viewModel.register(carnet, nombre, apellido, correo, password, rol)
                },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
